...
fprintf('%-5s %-4s %-16s %7s %7s %8s %10s %8s %9s %9s %7s %9s %9s %8s %7s\n', ...
    'Rank', 'OK', 'Detector', 'Pix', 'R', 'Slit', 'Grating', ...
    'alpha', 'f1', 'f2', 'F2', 'D2', 'Mslit', 'Npix', 'FoM');
...
for i = 1:n_display
    ...
    fprintf('%-5d %-4s %-16s %7.1f %7.0f %8.1f %10.0f %8.1f %9.1f %9.1f %7.2f %9.1f %9.2f %8.0f %7.2f\n', ...
        i, ...
        feasible_char, ...
        T_sorted.det_name{i}, ...
        T_sorted.pix_um(i), ...
